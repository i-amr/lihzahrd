...
class Tile:
    ...
    def __init__(
        ...
        extra: typing.Optional[
            typing.Union[Chest, Sign, WeighedPressurePlate, TileEntity]
        ] = None,
    ):
        if wiring is None:
            wiring = Wiring()
    ...
    def copy(self):
        return Tile(
            block=self.block.copy() if self.block else None,
            wall=self.wall.copy() if self.wall else None,
            liquid=self.liquid.copy() if self.liquid else None,
            wiring=self.wiring.copy() if self.wiring else None,
            extra=self.extra
        )
