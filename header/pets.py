...
class Pets:
    ...
    def __init__(self, cat: bool, dog: bool, bunny: bool):
        self.cat: bool = cat
        """Was the Cat License (https://terraria.wiki.gg/Cat_License) ever activated?"""

        self.dog: int = dog
        """Was the Dog License (https://terraria.wiki.gg/Dog_License) ever activated?"""

        self.bunny: float = bunny
        """Was the Bunny License (https://terraria.wiki.gg/Bunny_License) ever activated?"""
