...
class WallType(enum.IntEnum):
    ...
    SHIMMERFALL = 347
    FALLEN_STAR_WALL = 348
    STONE_UNSAFE = 349
    UNBREAKABLE_BLOCK_WALL = 350
    FEYWOOD_WALL = 351
    HALLOWED_BRICK_WALL = 352
    PINE_TREE_BLOCK_WALL = 353
    EASTER_BLOCK_WALL = 354
    GOTHIC_BRICK_WALL = 355
    FLINX_FUR_BLOCK_WALL = 356
    JELLYFISH_BLOCK_WALL = 357
    PINE_WOOD_BLOCK_WALL = 358
    HARPY_BLOCK_WALL = 359
    MOONPLATE_BLOCK_WALL = 360
    LIBRARIAN_BLOCK_WALL = 361
    SPIKE_BLOCK_WALL = 362
    OFFICE_BLOCK_WALL = 363
    FORBIDDEN_BLOCK_WALL = 364
    WATER_BLOCK_WALL = 365
    BOULDER_BLOCK_WALL = 366
